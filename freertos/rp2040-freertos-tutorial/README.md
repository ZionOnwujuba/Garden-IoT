# Garden IoT FreeRTOS Folder-Learning Folder
This folder is based off the rp2040-freertos-template from the Learn Embedded Systems youtube channel.

This folder is the implementation of the teachings of the Learn Embedded Systems RP2040 FreeRTOS tutorial.

This is the original test from the README:
