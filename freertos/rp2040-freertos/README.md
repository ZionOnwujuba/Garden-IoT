# Garden IoT FreeRTOS Folder - Implementation Folder
This folder is based off the rp2040-freertos-template from the Learn Embedded Systems youtube channel.

This folder is the implementation of the RP2040 software for the GardenIoT project.

This is the original text from the README:
